-- This whole setup here *might* be broken. Or maybe not! Who knows? I spent too long debugging
-- an issue, only for it to mysteriously go away, without me knowing why.
-- Place servers to have installed by default right here
local servers = {
  clangd = {},
  gopls = {},
  pyright = {},
